...
describe('Suite de Testes di Carrinho de Compras', () => {

    test('CT-01: Deve conceder frete gratis para compras de exatamente R$ 100', () => {
        const itens = [{ preco: 100, quantidade: 1}];
        expect(calcularTotal(itens, null)).toBe(100.00);
    });
    ...
    test('CT-02: Deve aplicar 10% de desconto com o cupom PROMO10', () => {
        ...
        expect(calcularTotal(itens, 'PROMO10')).toBe(60.00);
    });
    ...
    test('CT-04: Deve arredondar o valor final para duas cadas decimais', () => {
